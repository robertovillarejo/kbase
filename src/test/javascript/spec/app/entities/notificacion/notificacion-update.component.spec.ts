...
import NotificacionUpdateComponent from '@/entities/notificacion/notificacion-update.vue';
import NotificacionClass from '@/entities/notificacion/notificacion-update.component';
